...
// FIXME El enrutador no debe tener lógica, el manejo del response para enviar resultados se debe mantener en el controlador
// FIXME Falta un middleware que valide que :idQuest es un identificador con el formato definido, ejem: es un numero en cierto rango
...
// FIXME El enrutador no debe tener lógica, el manejo del response para enviar resultados se debe mantener en el controlador
// FIXME Falta un middleware que valide todo el cuerpo del request
// FIXME Para editar un recurso, en la ruta en los params se debe indicar el identificador del recurso
router.put('/', (req, res) => {
