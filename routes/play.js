...
// FIXME El enrutador no debe tener lógica, el manejo del response para enviar resultados se debe mantener en el controlador
// FIXME Falta un middleware que valide que :idGame es un identificador con el formato definido, ejem: es un numero en cierto rango
...
// FIXME El enrutador no debe tener lógica, el manejo del response para enviar resultados se debe mantener en el controlador
// FIXME Las rutas para eliminaciones deben tener en los params el id del recurso a eliminar
...
// FIXME El enrutador no debe tener lógica, el manejo del response para enviar resultados se debe mantener en el controlador
// FIXME Falta un middleware que valide todo el cuerpo del request
// FIXME No queda claro la diferencia entre addGame y addToDetails, si se estan agregando detalles a un recurso ya creado, la ruta no puede ser post, y debe tener en los params el id del recurso
